...
interface Props {
  /**
   * @description The title of the HeroFlats component.
   * @default "Click here to tweak this text however you want."
   */
  title?: string;
  /**
   * @description The description of the HeroFlats component.
   * @default "This text is fully editable and ready for your personal touch. Just click here, head over to the section window, or dive straight into the code to make changes as you see fit. Whether it's about the content, formatting, font, or anything in between, editing is just a click away."
   */
  description?: string;
  image?: ImageWidget;
  /**
   * @description The placement of the component. It can be "left" or "right".
   * @default "left"
   */
...
export default function HeroFlats({
  ...
  return (
    <nav class="lg:container lg:mx-auto mx-4 bg-green-300">
      ...
      <input type="email" class="input input-bordered mt-4" placeholder="Your email address" />
    </nav>
  );
}
